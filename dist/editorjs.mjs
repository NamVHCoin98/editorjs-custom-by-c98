...
class F extends we {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      c || u ? h = !0 : h = !(l.length > 0 && l.every((m) => {
        const { addedNodes: p, removedNodes: v, target: _ } = m;
        return [
          ...Array.from(p),
          ...Array.from(v),
          _
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some(
        (n) => Vt(n, this.toolRenderedElement)
      ) && this.didMutated(o);
...
`);
      ...
      function v(b, g) {
        for (var E = [], T = {}, A = 0; A < b.length; A++) {
          var I = b[A], z = g.base ? I[0] + g.base : I[0], L = { css: I[1], media: I[2], sourceMap: I[3] };
...
`);
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          var z = h++;
          E = u || (u = O(g)), T = R.bind(null, E, z, !1), A = R.bind(null, E, z, !0);
        } else
      ...
      t.exports = function(b, g) {
        ...
        return p(E, g), function(T) {
          for (var A = [], I = 0; I < E.length; I++) {
            var z = E[I];
            (L = a[z.id]).refs--, A.push(L);
          }
          for (T && p(v(T, g), g), I = 0; I < A.length; I++) {
            var L;
            if ((L = A[I]).refs === 0) {
...
`);
      ...
      function R(b, g, E, T) {
        ...
        if (b.styleSheet)
          ...
          var I = document.createTextNode(A), z = b.childNodes;
          z[g] && b.removeChild(z[g]), z.length ? b.insertBefore(I, z[g]) : b.appendChild(I);
        }
      }
    }, function(t, o) {
      t.exports = function(i) {
      ...
      t.exports = (n = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: m = function(p) {
        var v = document.createElement("DIV"), _ = document.createElement("DIV"), N = p.message, O = p.style;
        return v.classList.add(r), O && v.classList.add(r + "--" + O), v.innerHTML = N, _.classList.add(a), _.addEventListener("click", v.remove.bind(v)), v.appendChild(_), v;
      }, confirm: function(p) {
        var v = m(p), _ = document.createElement("div"), N = document.createElement("button"), O = document.createElement("button"), y = v.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return _.classList.add(f), N.innerHTML = p.okText || "Confirm", O.innerHTML = p.cancelText || "Cancel", N.classList.add(h), O.classList.add(h), N.classList.add(l), O.classList.add(c), x && typeof x == "function" && (O.addEventListener("click", x), y.addEventListener("click", x)), w && typeof w == "function" && N.addEventListener("click", w), N.addEventListener("click", v.remove.bind(v)), O.addEventListener("click", v.remove.bind(v)), _.appendChild(N), _.appendChild(O), v.appendChild(_), v;
      }, prompt: function(p) {
        var v = m(p), _ = document.createElement("div"), N = document.createElement("button"), O = document.createElement("input"), y = v.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return _.classList.add(f), N.innerHTML = p.okText || "Ok", N.classList.add(h), N.classList.add(l), O.classList.add(u), p.placeholder && O.setAttribute("placeholder", p.placeholder), p.default && (O.value = p.default), p.inputType && (O.type = p.inputType), x && typeof x == "function" && y.addEventListener("click", x), w && typeof w == "function" && N.addEventListener("click", function() {
          w(O.value);
        }), N.addEventListener("click", v.remove.bind(v)), _.appendChild(O), _.appendChild(N), v.appendChild(_), v;
      }, getWrapper: function() {
    ...
    t.prototype.clean = function(h) {
      ...
      if (p)
        do {
          ...
          var v = r(p), _;
          v && (_ = Array.prototype.some.call(p.childNodes, i));
          var N = !!f.parentNode, O = i(f) && i(p) && N, y = p.nodeName.toLowerCase(), x = l(this.config, y, p), w = v && _;
...
class P {
  ...
  constructor(e) {
    this.nodes = {
      ...
      this.nodes.icon.classList.remove(P.CSS.wobbleAnimation), this.nodes.icon.removeEventListener(
        "animationend",
        this.onErrorAnimationEnd
      );
  ...
  make(e) {
    ...
    e.name && (t.dataset.itemName = e.name), this.nodes.icon = d.make("div", P.CSS.icon, {
      innerHTML: e.icon || So
    }), t.appendChild(this.nodes.icon);
    const o = d.make("div", P.CSS.title, {
      innerHTML: e.title || ""
    });
  ...
  enableSpecialHoverAndFocusBehavior() {
    this.nodes.root.classList.add(P.CSS.noHover), this.nodes.root.classList.add(P.CSS.noFocus), this.nodes.root.addEventListener(
      "mouseleave",
      this.removeSpecialHoverBehavior,
      { once: !0 }
    );
...
var _o = Object.defineProperty, Oo = Object.getOwnPropertyDescriptor, No = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Oo(e, t) : e, n = s.length - 1, r; n >= 0; n--)
    (r = s[n]) && (i = (o ? r(e, t, i) : r(i)) || i);
  return o && i && _o(e, t, i), i;
}, fe = /* @__PURE__ */ ((s) => (s.Close = "close", s))(fe || {});
const H = class extends we {
  /**
   ...
   */
  show() {
    this.shouldOpenBottom || (this.nodes.popover.style.setProperty("--popover-height", this.height + "px"), this.nodes.popover.classList.add(H.CSS.popoverOpenTop)), this.nodes.overlay.classList.remove(H.CSS.overlayHidden), this.nodes.popover.classList.add(H.CSS.popoverOpened), this.flipper.activate(this.flippableElements), this.search !== void 0 && setTimeout(() => {
      this.search.focus();
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(H.CSS.popoverOpened), this.nodes.popover.classList.remove(H.CSS.popoverOpenTop), this.nodes.overlay.classList.add(H.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((s) => s.reset()), this.search !== void 0 && this.search.clear(), ee() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
  ...
  make() {
    ...
    }), this.nodes.wrapper = d.make("div"), this.nodes.overlay = d.make("div", [H.CSS.overlay, H.CSS.overlayHidden]), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
  ...
  addSearch() {
    ...
    s.classList.add(H.CSS.search), this.nodes.popover.insertBefore(s, this.nodes.popover.firstChild);
  }
  /**
   ...
   */
  addCustomContent(s) {
    this.nodes.customContent = s, this.nodes.customContent.classList.add(H.CSS.customContent), this.nodes.popover.insertBefore(s, this.nodes.popover.firstChild);
  }
  /**
  ...
  get height() {
    ...
    return e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-1000px", e.classList.add(H.CSS.popoverOpened), document.body.appendChild(e), s = e.offsetHeight, e.remove(), s;
  }
  /**
  ...
  toggleNothingFoundMessage(s) {
    this.nodes.nothingFoundMessage.classList.toggle(H.CSS.nothingFoundMessageDisplayed, s);
  }
  /**
  ...
  toggleCustomContent(s) {
    var e;
    (e = this.nodes.customContent) == null || e.classList.toggle(H.CSS.customContentHidden, s);
  }
  /**
...
class Uo extends C {
  ...
  move(e = null) {
    ...
    this.nodes.wrapper.classList.toggle(
      ...
      n < this.Editor.UI.contentRect.left
    ), this.nodes.wrapper.classList.toggle(
  ...
  async setConversionTogglerContent() {
    ...
    this.nodes.conversionToggler.hidden = !n, this.nodes.conversionToggler.classList.toggle(
  ...
  addTool(e) {
    ...
    n.appendChild(d.text(r)), i && n.appendChild(
...
class Wo extends C {
  ...
  handleCommandX(e) {
    ...
    t.anyBlockSelected && t.copySelectedBlocks(e).then(() => {
      const n = o.removeSelectedBlocks(), r = o.insertDefaultBlockAtIndex(
        n,
        !0
      );
...
const Je = "block-removed", Qe = "block-added", Yo = "block-moved", Ko = "block-changed";
class Xo extends C {
  constructor() {
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Yo, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
  ...
  bindBlockEvents(e) {
    ...
    ), e.on("didMutated", (o) => this.blockDidMutated(Ko, o, {
...
`), i = t.innerHTML;
    return e.clipboardData.setData("text/plain", o), e.clipboardData.setData("text/html", i), Promise.all(this.selectedBlocks.map((n) => n.save())).then(
      (n) => {
        try {
  ...
  constructor() {
    super(...arguments), this.onMouseUp = () => {
      ...
      if (!(!i || !n) && n !== i) {
        ...
        this.toggleBlocksSelectedState(i, n), this.lastSelectedBlock = n;
      }
    };
  }
  /**
...
class pe extends C {
  ...
  genInfoForMouseSelection() {
    ...
    let r;
    n !== void 0 && (r = this.Editor.BlockManager.blocks.findIndex(
      (h) => h.holder === n.holder
    ));
    ...
    return function(t) {
      ...
      function u(y, x) {
        for (var w = {}, M = [], R = 0; R < y.length; R++) {
          ...
          A !== -1 ? (l[A].references++, l[A].updater(I)) : l.push({ identifier: T, updater: O(I, x), references: 1 }), M.push(T);
        }
        return M;
      }
      function h(y) {
          ...
          return this.map(function(a) {
            var l = function(c, u) {
              ...
              if (u && typeof btoa == "function") {
                var m = (v = f, _ = btoa(unescape(encodeURIComponent(JSON.stringify(v)))), N = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(_), "/*# ".concat(N, " */")), p = f.sources.map(function(O) {
  ...
  wrap() {
    ...
    e.length > 1 ? e.forEach(async (t) => {
      ...
      if (t.name === "paragraph") {
        const r = {
          ...o,
          text: `<b>${(n = (i = o.text) == null ? void 0 : i.replace(/<b>/g, "")) == null ? void 0 : n.replace(/<\/b>/g, "")}</b>`
        };
        await this.api.blocks.update(t.id, r, {
  ...
  unwrap() {
    ...
    e.length > 1 ? e.forEach(async (t) => {
      ...
      if (t.name === "paragraph") {
        const r = {
          ...o,
          text: (n = (i = o.text) == null ? void 0 : i.replace(/<b>/g, "")) == null ? void 0 : n.replace(/<\/b>/g, "")
        };
        await this.api.blocks.update(t.id, r, {
          reSelectedAfterUpdate: !0
        });
...
class fi {
  ...
  set configuration(e) {
    ...
    j(e) ? this.config = {
      ...
      holder: e
    }, Ie(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = et.VERBOSE), Ot(this.config.logLevel), Ie(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
